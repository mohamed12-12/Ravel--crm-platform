...
Generated: 2026-05-13T14:05:09

## Identity Summary

- Travelers rows scanned: 775
- Valid Traveler IDs: 517
- Invalid Traveler IDs: 0
- True max Traveler ID: `TR00517` at row `518`
- Next Traveler ID: `TR00518`
- Duplicate Traveler ID keys: 0
- Duplicate phone lookup keys: 18
- Rows with ID but missing name or phone: 94
- Rows with phone but missing lookup key: 0
- Hidden rows with data: 180
- Auto filter range: `A1:AL902`
...
- `Info` `Travelers` row `2` `HIDDEN_ROW_WITH_DATA`: `TR00001` `Nada Adel` `44:7493723281` - This data row is hidden in the workbook.
- `Info` `Travelers` row `3` `HIDDEN_ROW_WITH_DATA`: `TR00002` `Ash` `966:583184475` - This data row is hidden in the workbook.
- `Info` `Travelers` row `5` `HIDDEN_ROW_WITH_DATA`: `TR00004` `Lamis El Hadidy` `971:555227188` - This data row is hidden in the workbook.
- `High` `Travelers` row `7` `TRAVELER_ID_WITH_MISSING_IDENTITY_DATA`: `TR00006` `Reine Abi Rached` `` - Missing: phone
- `Info` `Travelers` row `7` `HIDDEN_ROW_WITH_DATA`: `TR00006` `Reine Abi Rached` `` - This data row is hidden in the workbook.
- `High` `Travelers` row `8` `TRAVELER_ID_WITH_MISSING_IDENTITY_DATA`: `TR00007` `Linda` `` - Missing: phone
- `Info` `Travelers` row `8` `HIDDEN_ROW_WITH_DATA`: `TR00007` `Linda` `` - This data row is hidden in the workbook.
- `Info` `Travelers` row `9` `HIDDEN_ROW_WITH_DATA`: `TR00008` `Marie` `49:1725712232` - This data row is hidden in the workbook.
- `Info` `Travelers` row `10` `HIDDEN_ROW_WITH_DATA`: `TR00009` `Ahmed` `968:98962403` - This data row is hidden in the workbook.
- `Info` `Travelers` row `20` `HIDDEN_ROW_WITH_DATA`: `TR00019` `Sanaa` `33:777363649` - This data row is hidden in the workbook.
- `High` `Travelers` row `21` `TRAVELER_ID_WITH_MISSING_IDENTITY_DATA`: `TR00020` `Ali` `` - Missing: phone
- `Info` `Travelers` row `21` `HIDDEN_ROW_WITH_DATA`: `TR00020` `Ali` `` - This data row is hidden in the workbook.
